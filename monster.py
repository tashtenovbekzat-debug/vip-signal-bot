...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8492510753:AAE8aGjPdEwsttluLL581Ip-W9Y-ZtbgUo0").strip()
ADMIN_IDS_RAW = os.getenv("ADMIN_IDS", "8394704301").strip()
VIP_CHANNEL_ID_RAW = os.getenv("VIP_CHANNEL_ID", "-1003735072360").strip()
VIP_USERS_RAW = os.getenv("VIP_USERS", "8394704301").strip()
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "proj_Uy7rcBrQxfJqWODPgV3auoZE").strip()
